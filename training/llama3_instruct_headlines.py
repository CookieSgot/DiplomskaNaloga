...
prompt = "Si prepoznavalec sarkastičnih člankov. Odgovarjaš z samo 0, če podan naslov članka ni sarkastičen in z 1, če podan naslov članka je sarkastičen.\nNekaj primerov:\n"
...
for ind in train.index:
    example = "Naslov: '" + train["text"][ind] + "' Odgovor: " + str(train["label"][ind]) + "\n"
...
with open('headline_pred.txt', 'w') as file:

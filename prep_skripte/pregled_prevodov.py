...
file1 = pd.read_csv('teksti/reddit_sample_clean.csv')
file2 = pd.read_csv('prevodi/prevod_reddit.csv', index_col=[0])

df = pd.DataFrame(columns=["label","comment"], index=range(0,100))
...
df.to_csv('prevodi/pregled_prevodov.csv', index=False)